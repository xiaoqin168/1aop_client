...
var Affix = (_temp = _class = function (_React$Component) {
    ...
    Affix.prototype._setEventHandlerForContainer = function _setEventHandlerForContainer(getContainer) {
        ...
        _nextUtil.events.on(container, 'scroll', this._updateNodePosition);
        _nextUtil.events.on(container, 'resize', this._updateNodePosition);
    };

    Affix.prototype._removeEventHandlerForContainer = function _removeEventHandlerForContainer(getContainer) {
        var container = getContainer();
        if (container) {
            _nextUtil.events.off(container, 'scroll', this._updateNodePosition);
            _nextUtil.events.off(container, 'resize', this._updateNodePosition);
        }
    };
    ...
    onAffix: _nextUtil.func.noop
}, _temp);
Affix.displayName = 'Affix';
exports.default = _nextConfigProvider2.default.config(Affix);
