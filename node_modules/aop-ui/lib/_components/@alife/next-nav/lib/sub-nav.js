...
var SubNav = (_temp = _class = function (_Component) {
    ...
    SubNav.prototype.render = function render() {
        ...
        var iconEl = typeof icon === 'string' ? _react2.default.createElement(_nextIcon2.default, { className: prefix + 'nav-icon', type: icon }) : icon;
        if (iconOnly) {
            if (hasArrow) {
                iconEl = _react2.default.createElement(_nextIcon2.default, { className: prefix + 'nav-icon-only-arrow', type: mode === 'popup' ? 'arrow-right' : 'arrow-down' });
            } else if (!iconEl) {
                iconEl = _react2.default.createElement('span', { className: prefix + 'nav-icon-placeholder' });
            }
        }
