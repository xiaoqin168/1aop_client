...
var TimePicker = (_temp = _class = function (_Component) {
    ...
    TimePicker.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'label', 'state', 'placeholder', 'size', 'format', 'hasClear', 'hourStep', 'minuteStep', 'secondStep', 'disabledHours', 'disabledMinutes', 'disabledSeconds', 'popupAlign', 'popupTriggerType', 'popupContainer', 'popupStyle', 'popupClassName', 'popupProps', 'disabled', 'className', 'locale']);
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({}, _nextUtil.obj.pickOthers(TimePicker.propTypes, others), { className: classNames }),
    ...
    /**
     * 时间值（moment 对象，受控状态使用）
     */
    value: _utils.checkMomentObj,
    /**
     * 时间初值（moment 对象，非受控状态使用）
     */
...
exports.default = _nextConfigProvider2.default.config(TimePicker);
