...
var CascaderMenuItem = (_temp = _class = function (_Component) {
    ...
    CascaderMenuItem.prototype.handleKeyDown = function handleKeyDown(e) {
        if (!this.props.disabled) {
            if (e.keyCode === _nextUtil.KEYCODE.RIGHT || e.keyCODE === _nextUtil.KEYCODE.ENTER) {
                if (this.props.canExpand) {
                    this.handleExpand(true);
                }
            } else if (e.keyCode === _nextUtil.KEYCODE.LEFT || e.keyCode === _nextUtil.KEYCODE.ESC) {
                this.props.onFold();
            }
        }
    };
