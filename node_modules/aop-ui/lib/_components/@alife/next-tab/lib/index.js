...
var _nav = require('./tabs/nav.js');

var _nav2 = _interopRequireDefault(_nav);

var _content = require('./tabs/content.js');

var _content2 = _interopRequireDefault(_content);

var _tabItem = require('./tabs/tab-item.js');

var _tabItem2 = _interopRequireDefault(_tabItem);

var _utils = require('./tabs/utils.js');
...
var Tab = (_temp = _class = function (_Component) {
    ...
    function Tab(props, context) {
        ...
        _this.onNavKeyDown = function (e) {
            ...
            if (keyCode >= _nextUtil.KEYCODE.LEFT && keyCode <= _nextUtil.KEYCODE.DOWN) {
                e.preventDefault();
            }
            var newKey = void 0;
            if (keyCode === _nextUtil.KEYCODE.RIGHT || keyCode === _nextUtil.KEYCODE.DOWN) {
                newKey = _this.getNextActiveKey(true);
                _this.handleTriggerEvent(_this.props.triggerType, newKey);
            } else if (keyCode === _nextUtil.KEYCODE.LEFT || keyCode === _nextUtil.KEYCODE.UP) {
    ...
    Tab.prototype.setActiveKey = function setActiveKey(key) {
        ...
        if (key === activeKey || this.props.activeKey) {
            return;
        }
        this.setState({
            activeKey: key
    ...
    Tab.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({ className: classNames }, _nextUtil.obj.pickOthers(Tab.propTypes, others)),
            tabChildren
        );
    };
...
exports.default = _nextConfigProvider2.default.config(Tab);
