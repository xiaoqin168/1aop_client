...
var SelectableItem = (_temp = _class = function (_Component) {
    ...
    SelectableItem.prototype.handleKeyDown = function handleKeyDown(e) {
        if (e.keyCode === _nextUtil.KEYCODE.SPACE) {
            this.handleSelect(e);
        }
    ...
    SelectableItem.prototype.renderSelectedIcon = function renderSelectedIcon(selected) {
        ...
        var _root$props = root.props,
            ...
            hasSelectedIcon = _root$props.hasSelectedIcon;


        return hasSelectedIcon && selected ? _react2.default.createElement(_nextIcon2.default, { style: { left: inlineIndent + 'px' }, className: prefix + 'menu-icon-selected', type: 'select' }) : null;
    };
