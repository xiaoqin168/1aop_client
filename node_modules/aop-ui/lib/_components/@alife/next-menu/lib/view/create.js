...
var ContextMenu = (_temp = _class = function (_Component) {
    ...
    function ContextMenu(props) {
        ...
        bindCtx(_this, ['handleOverlayClose', 'handleOverlayOpen', 'handleSubMenuOpen', 'handleItemClick', 'getOverlay']);
        return _this;
    }
    ...
    ContextMenu.prototype.handleSubMenuOpen = function handleSubMenuOpen(openKeys) {
        var _props;
        ...
        this.props.onOpen && (_props = this.props).onOpen.apply(_props, [openKeys].concat(others));
    };
    ...
    ContextMenu.prototype.handleItemClick = function handleItemClick() {
        ...
        this.props.onItemClick && (_props2 = this.props).onItemClick.apply(_props2, arguments);
    };
    ...
    ContextMenu.prototype.render = function render() {
        ...
        var _props3 = this.props,
            ...
            _props3$overlayProps = _props3.overlayProps,
            overlayProps = _props3$overlayProps === undefined ? {} : _props3$overlayProps,
            others = (0, _objectWithoutProperties3.default)(_props3, ['className', 'popupClassName', 'target', 'align', 'offset', 'afterClose', 'overlayProps']);
...
function create(props) {
    ...
    var menu = void 0;
    (0, _reactDom.render)(_react2.default.createElement(ContextMenu, (0, _extends3.default)({ afterClose: closeChain }, others)), div, function () {
        menu = this;
    });
