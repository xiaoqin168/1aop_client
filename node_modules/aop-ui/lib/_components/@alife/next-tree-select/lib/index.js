...
var _util = require('../../next-tree/lib/view/util.js');
...
var TreeNode = _nextTree2.default.Node;
...
var TreeSelect = (_temp = _class = function (_Component) {
    ...
    function TreeSelect(props, context) {
        ...
        bindCtx(_this, ['handleSelect', 'handleCheck', 'handleSearch', 'handleVisibleChange', 'handleRemove', 'handleExpand']);
        ...
        var loop = function loop(children) {
            ...
            _react.Children.forEach(children, function (child) {
                if (_this8.searchedKeys.indexOf(child.key) > -1) {
                    ...
                    var hideNode = (0, _react.cloneElement)(child, { style: { display: 'none' } });
    ...
    TreeSelect.prototype.renderPopupContent = function renderPopupContent() {
        ...
        var _props3 = this.props,
            ...
            customTreeProps = _props3.treeProps,
    ...
    TreeSelect.prototype.render = function render() {
        var _props4 = this.props,
            ...
            popupContainer = _props4.popupContainer,
            popupProps = _props4.popupProps;
        ...
        return _react2.default.createElement(_nextSelect2.default, (0, _extends3.default)({ prefix: prefix,
            className: className,
            size: size,
            hasBorder: hasBorder,
...
exports.default = _nextConfigProvider2.default.config(TreeSelect);
