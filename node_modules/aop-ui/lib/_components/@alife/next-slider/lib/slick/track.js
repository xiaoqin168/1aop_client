...
var renderSlides = function renderSlides(specProps) {
    ...
    _react2.default.Children.forEach(specProps.children, function (elem, index) {
        ...
        var slickClasses = getSlideClasses((0, _extends3.default)({ activeIndex: index }, specProps));
        ...
        slides.push(_react2.default.cloneElement(child, {
            ...
            style: !_nextUtil.dom.hasDOM ? (0, _extends3.default)({ outline: 'none' }, childStyle, child.props.style) : (0, _extends3.default)({ outline: 'none' }, child.props.style, childStyle),
            onClick: onClick
        }));
