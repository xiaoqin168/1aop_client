...
var EventHandlers = {
    ...
    swipeMove: function swipeMove(e) {
        ...
        this.setState({
            ...
            swipeLeft: swipeLeft,
            trackStyle: (0, _trackHelper.getTrackCSS)((0, _extends3.default)({ left: swipeLeft }, this.props, this.state))
        });
    ...
    swipeEnd: function swipeEnd(e) {
        ...
        if (touchObject.swipeLength > minSwipe) {
            ...
            this.setState({
                trackStyle: (0, _trackHelper.getTrackAnimateCSS)((0, _extends3.default)({ left: currentLeft }, this.props, this.state))
            });
        }
    },
