...
var helpers = {
    initialize: function initialize(props) {
        ...
        var currentSlide = props.rtl ? slideCount - 1 - props.defaultActiveIndex : props.defaultActiveIndex;
        ...
        this.setState({
            ...
            var trackStyle = (0, _trackHelper.getTrackCSS)((0, _extends3.default)({ left: targetLeft }, props, _this.state));
    ...
    slideHandler: function slideHandler(index) {
        ...
        if (this.props.useCSS === false) {
            this.setState({
                currentSlide: currentSlide,
                trackStyle: (0, _trackHelper.getTrackCSS)((0, _extends3.default)({ left: currentLeft }, this.props, this.state))
            }, function () {
            ...
            this.setState({
                animating: true,
                currentSlide: currentSlide,
                trackStyle: (0, _trackHelper.getTrackAnimateCSS)((0, _extends3.default)({ left: targetLeft }, this.props, this.state))
            }, function () {
                this.animationEndCallback = setTimeout(callback, this.props.speed);
            });
        }
