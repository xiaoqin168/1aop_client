...
var Transfer = (_temp = _class = function (_Component) {
    ...
    Transfer.prototype.renderCenter = function renderCenter() {
        ...
        return _react2.default.createElement(
            ...
            mode === 'simple' ? _react2.default.createElement(_nextIcon2.default, { className: prefix + 'transfer-move', size: 'large', type: 'switch' }) : [_react2.default.createElement(
                _nextButton2.default,
                { key: 'l2r', className: prefix + 'transfer-operation', type: leftCheckedValue.length ? 'primary' : 'normal', disabled: disabled || !leftCheckedValue.length, onClick: this.handleMoveItem.bind(this, 'right') },
                operations[0]
            ), _react2.default.createElement(
                _nextButton2.default,
                { key: 'r2l', className: prefix + 'transfer-operation', type: rightCheckedValue.length ? 'primary' : 'normal', disabled: disabled || !rightCheckedValue.length, onClick: this.handleMoveItem.bind(this, 'left') },
                operations[1]
            )]
        );
    };
