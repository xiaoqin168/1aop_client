...
var Item = _nextMenu2.default.Item,
    CheckboxItem = _nextMenu2.default.CheckboxItem;
...
var TransferItem = (_temp = _class = function (_Component) {
    ...
    TransferItem.prototype.render = function render() {
        ...
        if (isSimple) {
            ...
            return _react2.default.createElement(Item, itemProps);
        }

        return _react2.default.createElement(CheckboxItem, (0, _extends3.default)({ checked: checked, onChange: onCheck.bind(this, item.value) }, itemProps));
    };
