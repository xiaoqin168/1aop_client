...
var _nextSearch = require('../../../next-search/lib/index.js');

var _nextSearch2 = _interopRequireDefault(_nextSearch);
...
var TransferPanel = (_temp = _class = function (_Component) {
    ...
    TransferPanel.prototype.renderSearch = function renderSearch() {
        ...
        return _react2.default.createElement(_nextSearch2.default, { shape: 'simple', className: prefix + 'transfer-panel-search', placeholder: searchPlaceholder || locale.searchPlaceholder, onChange: this.handleSearch });
    };
    ...
    TransferPanel.prototype.renderFooter = function renderFooter() {
        ...
        return _react2.default.createElement(
            'div',
            { className: prefix + 'transfer-panel-footer' },
            _react2.default.createElement(_nextCheckbox2.default, { disabled: disabled, checked: checked, indeterminate: indeterminate, onChange: this.handleAllCheck }),
            _react2.default.createElement(
                'span',
