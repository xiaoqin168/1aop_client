...
var Option = _nextSelect2.default.Option;
...
var Pagination = (_temp = _class = function (_Component) {
    ...
    Pagination.prototype.renderPageItem = function renderPageItem(index) {
        ...
        return _react2.default.createElement(
            ...
            (0, _extends3.default)({}, props, { key: index }),
            index
        );
    };
    ...
    Pagination.prototype.renderPageEllipsis = function renderPageEllipsis(idx) {
        ...
        return _react2.default.createElement(_nextIcon2.default, { className: prefix + 'pagination-ellipsis', type: 'ellipsis', key: 'ellipsis-' + idx });
    };
    ...
    Pagination.prototype.renderPageJump = function renderPageJump() {
        ...
        return [_react2.default.createElement(
            ...
            onKeyDown: function onKeyDown(e) {
                if (e.keyCode === _nextUtil.KEYCODE.ENTER) {
                    _this3.onJump(e);
                }
    ...
    Pagination.prototype.renderPageList = function renderPageList(current, totalPage) {
        var _props6 = this.props,
            ...
            pageShowCount = _props6.pageShowCount;
    ...
    Pagination.prototype.renderPageSizeSelector = function renderPageSizeSelector() {
        var _props7 = this.props,
            ...
            pageSizeSelector = _props7.pageSizeSelector,
    ...
    Pagination.prototype.render = function render() {
        ...
        var _props10 = this.props,
            ...
            type = _props10.type,
            size = _props10.size,
            shape = _props10.shape,
            className = _props10.className,
            total = _props10.total,
            totalRender = _props10.totalRender,
            pageSize = _props10.pageSize,
            pageSizeSelector = _props10.pageSizeSelector,
            pageSizeList = _props10.pageSizeList,
            pageSizePosition = _props10.pageSizePosition,
            useFloatLayout = _props10.useFloatLayout,
            onPageSizeChange = _props10.onPageSizeChange,
            hideOnlyOnePage = _props10.hideOnlyOnePage,
            showJump = _props10.showJump,
            locale = _props10.locale,
            current = _props10.current,
            defaultCurrent = _props10.defaultCurrent,
            pageShowCount = _props10.pageShowCount,
            link = _props10.link,
            onChange = _props10.onChange,
            others = (0, _objectWithoutProperties3.default)(_props10, ['prefix', 'pure', 'type', 'size', 'shape', 'className', 'total', 'totalRender', 'pageSize', 'pageSizeSelector', 'pageSizeList', 'pageSizePosition', 'useFloatLayout', 'onPageSizeChange', 'hideOnlyOnePage', 'showJump', 'locale', 'current', 'defaultCurrent', 'pageShowCount', 'link', 'onChange']);
        /* eslint-enable */
...
exports.default = _nextConfigProvider2.default.config(Pagination);
