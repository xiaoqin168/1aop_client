...
var Loading = (_temp = _class = function (_React$Component) {
    ...
    Loading.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Loading.propTypes, this.props);
        return fullScreen ? [children, _react2.default.createElement(
            _nextOverlay2.default,
            (0, _extends3.default)({ key: 'overlay', hasMask: true, align: 'cc cc' }, others, {
                className: className,
                style: style,
                visible: visible,
            ...
            _react2.default.createElement(
                'div',
                { className: visible ? prefix + 'loading-component' : null },
    ...
    /**
     * 自定义内容位置
     * @enumdesc right出现在动画右边 bottom出现在动画下面
     */
...
exports.default = _nextConfigProvider2.default.config(Loading);
