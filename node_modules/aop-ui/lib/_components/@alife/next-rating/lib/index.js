...
var Rating = (_temp = _class = function (_Component) {
    ...
    Rating.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Rating.propTypes, this.props);
        ...
        for (var i = 0; i < count; i++) {
            ...
            var iconNode = _react2.default.createElement(_nextIcon2.default, { type: iconType, size: sizeMap, className: iconCls });
...
exports.default = _nextConfigProvider2.default.config(Rating);
