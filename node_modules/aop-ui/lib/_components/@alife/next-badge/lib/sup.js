...
var Sup = (_temp = _class = function (_Component) {
    ...
    Sup.prototype.computeStyle = function computeStyle(removeTransition, revert) {
        ...
        if (supNode && _nextUtil.dom.hasClass(supNode, prefix + 'badge-count')) {
    ...
    Sup.prototype.render = function render() {
        ...
        var supClazz = (0, _classnames2.default)(prefix + 'badge-scroll-number', (_classNames = {}, _classNames[prefix + 'badge-count'] = !!count, _classNames[prefix + 'badge-dot'] = dot, _classNames[prefix + 'badge-custom'] = !!content, _classNames));
        ...
        var wrapper = _nextUtil.support.animation ? _react2.default.createElement(_nextAnimate2.default, { animation: animation }) : _react2.default.createElement('span', null);
