...
var _class, _temp; /**
                    * @alife/next-badge
                    * @author Fusion Team <https://next.alibaba-inc.com>
                    */
...
var Badge = (_temp = _class = function (_Component) {
    ...
    Badge.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Badge.propTypes, this.props);
        ...
        var clazz = (0, _classnames2.default)(prefix + 'badge', (_classNames = {}, _classNames[prefix + 'badge-not-a-wrapper'] = !children, _classNames), className);

        return _react2.default.createElement(
            'span',
            (0, _extends3.default)({ className: clazz }, others),
            children,
            _react2.default.createElement(_sup2.default, { prefix: prefix, content: content, count: count, overflowCount: overflowCount, dot: dot, style: style })
        );
    };
...
exports.default = _nextConfigProvider2.default.config(Badge);
