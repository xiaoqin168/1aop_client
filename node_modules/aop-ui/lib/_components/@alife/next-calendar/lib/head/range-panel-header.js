    ...
    RangePanelHeader.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { title: startMonthLabel, className: btnCls, onClick: function onClick() {
                ...
                _react2.default.createElement(
                    'button',
                    { title: startYearLable, className: btnCls, onClick: function onClick() {
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { title: endMonthLabel, className: btnCls, onClick: function onClick() {
                ...
                _react2.default.createElement(
                    'button',
                    { title: endYearLabel, className: btnCls, onClick: function onClick() {
