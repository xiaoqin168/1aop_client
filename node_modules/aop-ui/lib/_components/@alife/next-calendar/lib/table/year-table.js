...
var YearTable = function (_React$PureComponent) {
    ...
    YearTable.prototype.onYearCellClick = function onYearCellClick(date) {
        this.props.changeVisibleMonth(date);
        this.props.changeMode('month');
    };
        ...
        for (var i = 0; i < _utils.YEAR_TABLE_ROW_COUNT; i++) {
            ...
            for (var j = 0; j < _utils.YEAR_TABLE_COL_COUNT; j++) {
                ...
                if (i === 0 && j === 0) {
                    ...
                    content = _react2.default.createElement(_nextIcon2.default, { type: 'arrow-left', size: 'xs' });
                } else if (i === lastRowIndex && j === lastColIndex) {
                    title = locale.nextDecade;
                    onClick = goNextDecade;
                    content = _react2.default.createElement(_nextIcon2.default, { type: 'arrow-right', size: 'xs' });
                } else {
                ...
                var classNames = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'calendar-cell'] = true, _classnames[prefix + 'calendar-cell-current'] = year === currentYear, _classnames[prefix + 'selected'] = year === selectedYear, _classnames[prefix + 'disabled'] = isDisabled, _classnames));

                rowElements.push(_react2.default.createElement(
                    'td',
                    { key: i + '-' + j, className: classNames },
                    _react2.default.createElement(
                        'div',
                        { className: prefix + 'calendar-year', onClick: onClick, title: title },
                        content
                    )
                ));
            }
