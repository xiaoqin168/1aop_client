...
var _rangePanelHeader = require('./head/range-panel-header.js');
...
var RangeCalendar = (_temp = _class = function (_React$Component) {
    ...
    function RangeCalendar(props, context) {
        ...
        _this.changeVisibleMonth = function (date) {
            _this.setState({
    ...
    RangeCalendar.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'dateCellRender', 'onSelect', 'className', 'locale', 'showOtherMonth', 'disabledDate']);
        ...
        switch (mode) {
            case 'date':
                {
                    table = [_react2.default.createElement(
                        ...
                        _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({}, tableProps, { visibleMonth: startVisibleMonth }))
                    ), _react2.default.createElement(
                        'div',
                        { className: prefix + 'calendar-body-right', key: 'right-panel' },
                        _react2.default.createElement(_dateTable2.default, (0, _extends3.default)({}, tableProps, { visibleMonth: endVisibleMonth }))
                    )];
            ...
            case 'month':
                {
                    table = _react2.default.createElement(_monthTable2.default, (0, _extends3.default)({}, tableProps, { visibleMonth: visibleMonth }));
                    header = _react2.default.createElement(_monthPanelHeader2.default, (0, _extends3.default)({}, headerProps, { visibleMonth: visibleMonth, goPrevYear: this.goPrevYear, goNextYear: this.goNextYear }));
                    break;
                }
            case 'year':
                {
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({}, _nextUtil.obj.pickOthers(RangeCalendar.propTypes, others), { className: classNames }),
            header,
            _react2.default.createElement(
                'div',
