 ...
 * @exports
 * <Boolean> hasDOM,
 * <Function> hasClass, addClass, removeClass, toggleClass, matches, getStyle, setStyle, scrollbar,
 *
 * NOTE 在 IE10+ 中，虽然支持 classList，但仍然不支持 addClass 等方法的多参数，所以本模块 export 的方法不支持批量添加 className
 */
