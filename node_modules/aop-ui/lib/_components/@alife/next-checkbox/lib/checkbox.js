...
var Checkbox = (_temp = _class = function (_UIState) {
    ...
    Checkbox.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Checkbox.propTypes, otherProps);
        var othersData = _nextUtil.obj.pickAttrsWith(others, 'data-');

        var childInput = _react2.default.createElement('input', (0, _extends3.default)({}, _nextUtil.obj.pickOthers(Checkbox.propTypes, otherProps), {
            id: id,
            disabled: disabled,
            checked: checked,
            type: 'checkbox',
...
exports.default = _nextConfigProvider2.default.config(Checkbox);
