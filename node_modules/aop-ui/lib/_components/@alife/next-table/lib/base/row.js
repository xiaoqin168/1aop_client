...
var Row = (_temp2 = _class = function (_React$Component) {
    ...
    Row.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
        if (nextProps.pure) {
            var isEqual = _nextUtil.obj.shallowEqual(this.props, nextProps);
            return !isEqual;
        }
    ...
    Row.prototype.onRowHover = function onRowHover(record, index, isEnter, e) {
        ...
        if (isEnter) {
            ...
            currentRow && _nextUtil.dom.addClass(currentRow, 'hovered');
        } else {
            onMouseLeave(record, index, e);
            currentRow && _nextUtil.dom.removeClass(currentRow, 'hovered');
        }
    };
    ...
    Row.prototype.renderCells = function renderCells(record) {
        ...
        return columns.map(function (child, colIndex) {
            ...
            var dataIndex = child.dataIndex,
                align = child.align,
                width = child.width,
                others = (0, _objectWithoutProperties3.default)(child, ['dataIndex', 'align', 'width']);

            var value = (0, _util.fetchDataByPath)(record, dataIndex);
            ...
            return _react2.default.createElement(Cell, (0, _extends3.default)({ key: colIndex
            }, others, attrs, {
    ...
    Row.prototype.render = function render() {
        ...
        var _props3 = this.props,
            ...
            pure = _props3.pure,
            others = (0, _objectWithoutProperties3.default)(_props3, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'getCellProps', 'rowIndex', 'record', 'children', 'primaryKey', 'cellRef', 'colGroup', 'pure']);
        ...
        return _react2.default.createElement(
            'tr',
            (0, _extends3.default)({ className: cls, role: 'row' }, others, {
