...
var Header = (_temp2 = _class = function (_React$Component) {
    ...
    Header.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            pure = _props.pure,
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'children', 'component', 'colGroup', 'columns', 'locale', 'filterParams', 'onFilter', 'components', 'headerCellRef', 'onSort', 'onResizeChange', 'pure']);
        ...
        var header = columns.map(function (cols, index) {
            var col = cols.map(function (col, j) {
                ...
                var title = col.title,
                    ...
                    lock = col.lock,
                    others = (0, _objectWithoutProperties3.default)(col, ['title', 'colSpan', 'sortable', 'resizable', 'dataIndex', 'filters', 'filterMode', 'width', 'align', 'className', '__normalized', 'lock']);
                ...
                if (col.children && col.children.length) {
                    ...
                    if (sortable) {
                        sortElement = _react2.default.createElement(Sort, { prefix: prefix, dataIndex: dataIndex, onSort: _this2.onSort, sort: sort });
                    }
                    if (resizable) {
