...
var Cell = (_temp = _class = function (_React$Component) {
    ...
    Cell.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            lock = _props.lock,
            pure = _props.pure,
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'cell', 'value', 'resizable', 'colIndex', 'rowIndex', 'record', 'context', 'align', 'style', 'component', 'children', 'title', 'width', 'innerStyle', 'primaryKey', '__normalized', 'filterMode', 'filters', 'sortable', 'lock', 'pure']);
        ...
        return _react2.default.createElement(
            Tag,
            (0, _extends3.default)({}, others, { className: cls, style: style, role: 'gridcell' }),
