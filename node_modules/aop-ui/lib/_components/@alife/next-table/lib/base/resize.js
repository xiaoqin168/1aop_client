...
var Resize = (_temp2 = _class = function (_React$Component) {
    ...
    function Resize() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.onMouseDown = function (e) {
            ...
            _nextUtil.events.on(document, 'mousemove', _this.onMouseMove);
            _nextUtil.events.on(document, 'mouseup', _this.onMouseUp);
            _this.unSelect();
    ...
    Resize.prototype.destory = function destory() {
        _nextUtil.events.off(document, 'mousemove', this.onMouseMove);
        _nextUtil.events.off(document, 'mouseup', this.onMouseMove);
        this.select();
    };

    Resize.prototype.unSelect = function unSelect() {
        _nextUtil.dom.setStyle(document.body, {
            userSelect: 'none',
            cursor: 'ew-resize'
        });
