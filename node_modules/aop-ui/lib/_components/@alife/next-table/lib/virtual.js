...
var _body = require('./virtual/body.js');
...
function virtual(BaseComponent) {
    ...
    var VirtualTable = (_temp2 = _class = function (_React$Component) {
        ...
        VirtualTable.prototype.reComputeSize = function reComputeSize() {
            var useVirtual = this.props.useVirtual;
            var rowHeight = this.state.rowHeight;

            if (typeof rowHeight === 'function' && useVirtual) {
                var row = this.getRowNode();
                var rowClientHeight = row.clientHeight;
        ...
        VirtualTable.prototype.getVisibleRange = function getVisibleRange(start) {
        ...
        VirtualTable.prototype.adjustSize = function adjustSize() {
            ...
            if (useVirtual) {
                ...
                if (clientWidth < tableClientWidth) {
                    _nextUtil.dom.setStyle(virtualScrollNode, 'width', tableClientWidth);
                    var leftNode = this.bodyLeftNode;
                    var rightNode = this.bodyRightNode;
                    leftNode && _nextUtil.dom.setStyle(leftNode, 'max-height', clientHeight);
                    rightNode && _nextUtil.dom.setStyle(rightNode, 'max-height', clientHeight);
        ...
        VirtualTable.prototype.getRowNode = function getRowNode() {
            return (0, _reactDom.findDOMNode)(this.table.getRowRef(1));
        };
        ...
        VirtualTable.prototype.render = function render() {
            ...
            return _react2.default.createElement(BaseComponent, (0, _extends3.default)({}, others, { dataSource: dataSource, components: components, fixedHeader: fixedHeader }));
        };
    ...
    (0, _util.statics)(VirtualTable, BaseComponent);
    return VirtualTable;
}
