...
var _row = require('./expanded/row.js');
...
function expanded(BaseComponent) {
    ...
    var ExpandedTable = (_temp2 = _class = function (_React$Component) {
        ...
        function ExpandedTable() {
            ...
            return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
                ...
                var openRowKeys = _this.state.openRowKeys,
                    ...
                    switchNode = openRowKeys.indexOf(record[primaryKey]) > -1 ? _react2.default.createElement(_nextIcon2.default, { type: 'minus', size: 'xs' }) : _react2.default.createElement(_nextIcon2.default, { type: 'add', size: 'xs' }),
                ...
                return _react2.default.createElement(
                    'span',
                    (0, _extends3.default)({}, attrs, { className: cls }),
                    switchNode
                );
        ...
        ExpandedTable.prototype.render = function render() {
            ...
            var _props = this.props,
                ...
                others = (0, _objectWithoutProperties3.default)(_props, ['components', 'openRowKeys', 'expandedRowRender', 'hasExpandedRowCtrl', 'children', 'dataSource', 'getExpandedColProps', 'expandedRowIndent', 'onRowOpen', 'onExpandedRowClick']);
            ...
            return _react2.default.createElement(
                BaseComponent,
                (0, _extends3.default)({}, others, { dataSource: dataSource, components: components }),
                children
            );
        };
    ...
    (0, _util.statics)(ExpandedTable, BaseComponent);
    return ExpandedTable;
}
