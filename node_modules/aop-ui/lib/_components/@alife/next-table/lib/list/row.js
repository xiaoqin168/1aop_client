...
var GroupListRow = (_temp = _class = function (_Row) {
    ...
    GroupListRow.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'onClick', 'onMouseEnter', 'onMouseLeave', 'columns', 'Cell', 'rowIndex', 'record', 'children', 'primaryKey', 'colGroup', 'cellRef', 'getCellProps']);
        ...
        if (children) {
            return children.map(function (child, index) {
                ...
                if (_this2.isChildrenSelection()) {
                    if (!child[primaryKey]) {
                        _nextUtil.log.warning('record.children should contains primaryKey when childrenSelection is true.');
                    }
                    return _react2.default.createElement(
                        'tr',
                ...
                if (_this2.context.rowSelection) {
                    cells.shift();
                    cells[0] = _react2.default.cloneElement(cells[0], (0, _extends3.default)({
                        colSpan: 2
                    }, cells[0].props));
                }
                return _react2.default.createElement(
    ...
    GroupListRow.prototype.renderContent = function renderContent(type) {
        ...
        var listNode = void 0;
        if (list) {
            var hasChildrenSelection = list.hasChildrenSelection;
