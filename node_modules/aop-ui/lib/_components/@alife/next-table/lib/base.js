...
var _nextLoading = require('../../next-loading/lib/index.js');

var _nextLoading2 = _interopRequireDefault(_nextLoading);
...
var _body = require('./base/body.js');

var _body2 = _interopRequireDefault(_body);

var _header = require('./base/header.js');

var _header2 = _interopRequireDefault(_header);

var _wrapper = require('./base/wrapper.js');

var _wrapper2 = _interopRequireDefault(_wrapper);

var _row = require('./base/row.js');
...
var _filter = require('./base/filter.js');

var _filter2 = _interopRequireDefault(_filter);

var _sort = require('./base/sort.js');
...
var Table = (_temp = _class = function (_React$Component) {
    ...
    Table.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState, nextContext) {
        if (nextProps.pure) {
            var isEqual = (0, _shallowElementEquals2.default)(nextProps, this.props) && _nextUtil.obj.shallowEqual(nextState, this.state) && _nextUtil.obj.shallowEqual(nextContext, this.context);
            return !isEqual;
        }
            ...
            Children.forEach(children, function (child) {
                if (child) {
                    ...
                    if (!(child && typeof child.type === 'function' && (child.type._typeMark === 'column' || child.type._typeMark === 'columnGroup'))) {
                        _nextUtil.log.warning('Use <Table.Column/>, <Table.ColumnGroup/> as child.');
                    }
                    ret.push(_props);
    ...
    Table.prototype.renderTable = function renderTable(groupChildren, flatChildren) {
        if (flatChildren.length || !flatChildren.length && !this.props.lockType) {
            ...
            return _react2.default.createElement(
                Wrapper,
                { colGroup: colGroup, ref: this.getWrapperRef, prefix: prefix },
                hasHeader ? _react2.default.createElement(Header, { prefix: prefix,
                    pure: pure,
                    colGroup: colGroup,
                ...
                _react2.default.createElement(Body, { prefix: prefix,
                    pure: pure,
                    colGroup: colGroup,
    ...
    Table.prototype.render = function render() {
        ...
        var table = this.renderTable(ret.groupChildren, ret.flatChildren),
            ...
            refs = _props3.refs,
            pure = _props3.pure,
            others = (0, _objectWithoutProperties3.default)(_props3, ['className', 'hasBorder', 'isZebra', 'loading', 'hasHeader', 'prefix', 'dataSource', 'onSort', 'onResizeChange', 'onRowClick', 'onRowMouseEnter', 'onRowMouseLeave', 'onFilter', 'getRowProps', 'getCellProps', 'primaryKey', 'components', 'wrapperContent', 'lockType', 'locale', 'refs', 'pure']),
        ...
        if (loading) {
            return _react2.default.createElement(
                _nextLoading2.default,
                { shape: 'fusion-reactor', className: prefix + 'table-loading' },
                content
            );
        }
        return content;
...
exports.default = _nextConfigProvider2.default.config(Table);
