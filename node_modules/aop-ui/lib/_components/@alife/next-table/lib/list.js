...
var _listHeader = require('./list-header.js');

var _listHeader2 = _interopRequireDefault(_listHeader);

var _listFooter = require('./list-footer.js');

var _listFooter2 = _interopRequireDefault(_listFooter);

var _row = require('./list/row.js');

var _row2 = _interopRequireDefault(_row);

var _body = require('./list/body.js');
...
function list(BaseComponent) {
    ...
    var ListTable = (_temp = _class = function (_React$Component) {
        ...
        ListTable.prototype.render = function render() {
            ...
            return _react2.default.createElement(BaseComponent, (0, _extends3.default)({}, others, { components: components, children: ret, className: className, prefix: prefix }));
        };
