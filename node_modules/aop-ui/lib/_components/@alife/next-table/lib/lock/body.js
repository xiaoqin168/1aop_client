...
var LockBody = (_temp2 = _class = function (_React$Component) {
    ...
    function LockBody() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.onBodyScroll = function () {
    ...
    LockBody.prototype.render = function render() {
        return _react2.default.createElement(_body2.default, (0, _extends3.default)({}, this.props, { onScroll: this.onBodyScroll, onWheel: this.onBodyWheel }));
    };
