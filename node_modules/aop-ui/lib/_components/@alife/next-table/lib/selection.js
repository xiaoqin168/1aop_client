...
var _row = require('./selection/row.js');
...
function selection(BaseComponent) {
    ...
    var SelectionTable = (_temp = _class = function (_React$Component) {
        ...
        function SelectionTable(props, context) {
            ...
            _this.renderSelectionHeader = function () {
                ...
                return mode === 'multiple' ? _react2.default.createElement(_nextCheckbox2.default, (0, _extends3.default)({ checked: checked, onChange: onChange }, attrs)) : null;
            };
            ...
            _this.renderSelectionBody = function (value, index, record) {
                ...
                return mode === 'multiple' ? _react2.default.createElement(_nextCheckbox2.default, (0, _extends3.default)({ checked: checked, onChange: onChange }, attrs)) : _react2.default.createElement(_nextRadio2.default, (0, _extends3.default)({ checked: checked, onChange: onChange }, attrs));
            };
            ...
            _this.selectAllRow = function (checked, e) {
                ...
                _this.flatDataSource(dataSource).forEach(function (record, index) {
        ...
        SelectionTable.prototype.selectOneRow = function selectOneRow(index, record, checked, e) {
            ...
            if (!id) {
                _nextUtil.log.warning('Can\'t get value from record using given ' + primaryKey + ' as primaryKey.');
            }
            if (mode === 'multiple') {
                if (checked) {
    ...
    (0, _util.statics)(SelectionTable, BaseComponent);
    return SelectionTable;
}
