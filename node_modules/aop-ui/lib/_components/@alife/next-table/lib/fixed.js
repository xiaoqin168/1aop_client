...
var _header = require('./fixed/header.js');

var _header2 = _interopRequireDefault(_header);

var _body = require('./fixed/body.js');
...
function fixed(BaseComponent) {
    ...
    var FixedTable = (_temp2 = _class = function (_React$Component) {
        ...
        FixedTable.prototype.adjustFixedHeaderSize = function adjustFixedHeaderSize() {
            ...
            if (hasHeader && fixedHeader && !this.props.lockType) {
                if (this.bodyNode.scrollHeight <= maxBodyHeight) {
                    _nextUtil.dom.setStyle(this.headerNode, 'paddingRight', 0);
                } else {
                    _nextUtil.dom.setStyle(this.headerNode, 'paddingRight', _nextUtil.dom.scrollbar().width);
                }
            }
        };
        ...
        FixedTable.prototype.render = function render() {
            ...
            return _react2.default.createElement(BaseComponent, (0, _extends3.default)({}, others, { components: components, className: className, prefix: prefix }));
        };
    ...
    (0, _util.statics)(FixedTable, BaseComponent);
    return FixedTable;
}
