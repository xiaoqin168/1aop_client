...
var _header3 = require('./sticky/header.js');
...
function sticky(BaseComponent) {
    ...
    var StickyTable = (_temp = _class = function (_React$Component) {
        ...
        StickyTable.prototype.render = function render() {
            ...
            return _react2.default.createElement(BaseComponent, (0, _extends3.default)({}, others, { components: components, fixedHeader: fixedHeader, maxBodyHeight: maxBodyHeight }));
        };
