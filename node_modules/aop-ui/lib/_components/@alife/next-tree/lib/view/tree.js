...
var _treeNode = require('./tree-node.js');
...
var getOffset = _nextUtil.dom.getOffset;
...
var Tree = (_temp = _class = function (_Component) {
    ...
    Tree.prototype.getExpandedKeys = function getExpandedKeys(props, willReceiveProps) {
        ...
        if (!willReceiveProps && props.defaultExpandAll) {
            ...
            expandedKeys = (0, _util.normalizeToArray)(expandedKeys);

            if (props.autoExpandParent) {
                var expandedPoss = expandedKeys.map(function (key) {
                    return _this3._k2n[key].pos;
                });
    ...
    Tree.prototype.getSelectedKeys = function getSelectedKeys(props, willReceiveProps) {
        ...
        selectedKeys = (0, _util.normalizeToArray)(selectedKeys);
        return selectedKeys;
    };
    ...
    Tree.prototype.getCheckedKeys = function getCheckedKeys(props, willReceiveProps) {
        ...
        if (checkStrictly) {
            if (Object.prototype.toString.call(checkedKeys) === '[object Object]') {
                checkedKeys = (0, _util.normalizeToArray)(checkedKeys.checked);
                this.indeterminateKeys = (0, _util.normalizeToArray)(checkedKeys.indeterminate);
            } else {
                checkedKeys = (0, _util.normalizeToArray)(checkedKeys);
            }
        } else {
            checkedKeys = (0, _util.getAllCheckedKeys)(checkedKeys, this._k2n, this._p2n);
    ...
    Tree.prototype.handleCheck = function handleCheck(check, key, node) {
        ...
        if (checkStrictly) {
            ...
            ps.forEach(function (p) {
                if ((0, _util.isDescendantOrSelf)(pos, p)) {
                    _this5.processKey(checkedKeys, _this5._p2n[p].key, check);
                }
            });
            ...
            for (var i = nums.length; i > 2; i--) {
                ...
                for (var j = 0; j < ps.length; j++) {
                    var p = ps[j];
                    if ((0, _util.isSiblingOrSelf)(currentPos, p)) {
        ...
        switch (checkedStrategy) {
            case 'parent':
                newCheckedKeys = (0, _util.filterChildKey)(checkedKeys, this._k2n);
                break;
            case 'child':
                newCheckedKeys = (0, _util.filterParentKey)(checkedKeys, this._k2n);
                break;
            default:
    ...
    Tree.prototype.getNodeProps = function getNodeProps(key) {
        ...
        return {
            ...
            eventKey: key,
            pos: pos,
            parentNode: this.getParentNode(pos),
    ...
    Tree.prototype.getIndeterminateKeys = function getIndeterminateKeys(checkedKeys) {
        ...
        var poss = (0, _util.filterChildKey)(checkedKeys, this._k2n).map(function (key) {
            return _this7._k2n[key].pos;
        });
        poss.forEach(function (pos) {
            var nums = pos.split('-');
            for (var i = nums.length; i > 2; i--) {
                var parentPos = nums.slice(0, i - 1).join('-');
                var parentKey = _this7._p2n[parentPos].key;
    ...
    Tree.prototype.handleDragStart = function handleDragStart(e, node) {
        ...
        this.dragNodesKeys = Object.keys(this._k2n).filter(function (k) {
            return (0, _util.isDescendantOrSelf)(_this8._k2n[dragNodeKey].pos, _this8._k2n[k].pos);
        });
    ...
    Tree.prototype.handleDrop = function handleDrop(e, node) {
        if ((0, _util.isDescendantOrSelf)(this._k2n[this.dragNode.props.eventKey].pos, this._k2n[node.props.eventKey].pos)) {
            return;
        }
    ...
    Tree.prototype.renderByDataSource = function renderByDataSource() {
        ...
        var loop = function loop(data) {
            ...
            return data.map(function (item, index) {
                ...
                var props = (0, _extends3.default)({}, others, _this9.getNodeProps(key));
                if (children && children.length) {
                    props.children = loop(children, pos);
                }
                var node = _react2.default.createElement(_treeNode2.default, (0, _extends3.default)({ key: key }, props));
                _this9._k2n[key].node = node;
                return node;
            });
        };
    ...
    Tree.prototype.renderByChildren = function renderByChildren() {
        ...
        var loop = function loop(children) {
            ...
            return _react.Children.map(children, function (child, index) {
                ...
                var props = _this10.getNodeProps(key);
...
exports.default = _nextConfigProvider2.default.config(Tree);
