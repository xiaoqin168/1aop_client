...
var _treeNodeInput = require('./tree-node-input.js');
...
var isPromise = _nextUtil.obj.isPromise,
    pickOthers = _nextUtil.obj.pickOthers;
...
var TreeNode = (_temp = _class = function (_Component) {
    ...
    TreeNode.prototype.renderSwitcher = function renderSwitcher() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(_nextIcon2.default, { className: prefix + 'tree-switcher-icon', type: iconType })
        );
    };
    ...
    TreeNode.prototype.renderCheckbox = function renderCheckbox() {
        ...
        return _react2.default.createElement(_nextCheckbox2.default, { checked: checked, indeterminate: indeterminate, disabled: disabled || checkboxDisabled, onChange: this.handleCheck });
    };
