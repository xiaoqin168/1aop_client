...
var IframeUploader = (_temp = _class = function (_React$Component) {
    ...
    IframeUploader.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'span',
            { className: className, style: (0, _extends3.default)({
                    position: 'relative',
                    zIndex: 0,
            ...
            _react2.default.createElement(
                ...
                { ref: 'form', method: 'post', action: this.props.action, encType: 'multipart/form-data',
                    target: iframeName },
                _react2.default.createElement('input', { ref: 'input', type: 'file', accept: accept, name: name, onChange: this.onSelect,
                    style: INPUT_STYLE }),
