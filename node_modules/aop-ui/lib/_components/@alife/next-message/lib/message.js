...
var Message = (_temp2 = _class = function (_Component) {
  ...
  Message.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'pure', 'className', 'type', 'shape', 'size', 'title', 'children', 'defaultVisible', 'visible', 'iconType', 'closeable', 'onClose', 'afterClose', 'animation']);
    /* eslint-enable */
    ...
    var newChildren = visible ? _react2.default.createElement(
      ...
      closeable ? _react2.default.createElement(
        'a',
        { href: 'javascript:;', className: messagePrefix + '-close', onClick: this.onClose },
        _react2.default.createElement(_nextIcon2.default, { type: 'close' })
      ) : null,
      _react2.default.createElement(_nextIcon2.default, { className: messagePrefix + '-symbol', type: iconType }),
  ...
  afterClose: noop,
  animation: true
}, _class.show = function (props) {
  return _toast2.default.show(props);
}, _class.success = function (props) {
  return _toast2.default.success(props);
}, _class.warning = function (props) {
  return _toast2.default.warning(props);
}, _class.error = function (props) {
  return _toast2.default.error(props);
}, _class.notice = function (props) {
  return _toast2.default.notice(props);
}, _class.help = function (props) {
  return _toast2.default.help(props);
}, _class.loading = function (props) {
  return _toast2.default.loading(props);
}, _class.hide = function () {
  return _toast2.default.hide();
}, _temp2);
Message.displayName = 'Message';
exports.default = _nextConfigProvider2.default.config(Message);
