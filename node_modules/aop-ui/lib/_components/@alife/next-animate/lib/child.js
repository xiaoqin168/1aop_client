...
var on = _nextUtil.events.on,
    off = _nextUtil.events.off;
...
var AnimateChild = (_temp = _class = function (_Component) {
    ...
    function AnimateChild(props) {
        ...
        _nextUtil.func.bindCtx(_this2, ['handleEnter', 'handleEntering', 'handleEntered', 'handleExit', 'handleExiting', 'handleExited', 'addEndListener']);
        _this2.endListeners = {
            transitionend: [],
            animationend: []
        };
    ...
    AnimateChild.prototype.generateEndListener = function generateEndListener(node, done, eventName) {
        var _this = this;
    ...
    AnimateChild.prototype.addEndListener = function addEndListener(node, done) {
        ...
        if (_nextUtil.support.transition || _nextUtil.support.animation) {
            this.node = node;
            if (_nextUtil.support.transition) {
                var transitionEndListener = this.generateEndListener(node, done, 'transitionend');
            ...
            if (_nextUtil.support.animation) {
                var animationEndListener = this.generateEndListener(node, done, 'animationend');
    ...
    AnimateChild.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['names', 'onAppear', 'onAppeared', 'onAppearing', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited']);
        /* eslint-enable no-unused-vars */

        return _react2.default.createElement(_reactTransitionGroup.Transition, (0, _extends3.default)({}, others, {
