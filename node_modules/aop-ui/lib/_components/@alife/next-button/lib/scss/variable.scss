...
/// @order {"statement/normal":10,"statement/hover":11,"statement/disabled":12,"statement/loading":13,"size/bounding":10,"size/icon":11,"size/text":12}
////
...
// unconfiguable height
$btn-size-s-height: $form-element-small-height;
$btn-size-s-corner: $form-element-small-corner;

$btn-size-m-height: $form-element-medium-height;
$btn-size-m-corner: $form-element-medium-corner;

$btn-size-l-height: $form-element-large-height;
$btn-size-l-corner: $form-element-large-corner;

/// shadow
/// @namespace statement/normal
$btn-shadow: $shadow-0 !default;

/// shadow
/// @namespace statement/hover
$btn-shadow-hover: $shadow-0 !default;

// Small
// ----------------------------------------

$btn-size-s-font: $form-element-small-font-size !default;
$btn-size-s-icon-size: $form-element-small-icon-size !default;
...
$btn-size-m-font: $form-element-medium-font-size !default;
$btn-size-m-icon-size: $form-element-medium-icon-size !default;
...
$btn-size-l-font: $form-element-large-font-size !default;
$btn-size-l-icon-size: $form-element-large-icon-size !default;
