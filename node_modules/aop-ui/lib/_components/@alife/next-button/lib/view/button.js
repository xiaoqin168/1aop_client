...
var Button = (_temp2 = _class = function (_Component) {
    ...
    Button.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'shape', 'type', 'size', 'htmlType', 'loading', 'text', 'warning', 'ghost', 'component', 'iconSize', 'children']);

        var ghostType = ['light', 'dark'].indexOf(ghost) >= 0 ? ghost : 'dark';

        if (shape) {
            _nextUtil.log.deprecated('shape', 'warning/text', 'Button');
        }

        var btnCls = (0, _classnames2.default)((_classNames = {}, _classNames[prefix + 'btn'] = true, _classNames['' + prefix + size] = size, _classNames[prefix + 'btn-' + type] = type && !ghost, _classNames[prefix + 'btn-text'] = text || shape === 'text', _classNames[prefix + 'btn-warning'] = warning || shape === 'warning', _classNames[prefix + 'btn-loading'] = loading, _classNames[prefix + 'btn-ghost'] = ghost, _classNames[prefix + 'btn-' + ghostType] = ghost, _classNames[className] = className, _classNames));
        ...
        var tagAttrs = (0, _extends3.default)({}, others, {
            type: htmlType,
            className: btnCls
        });
        ...
        return _react2.default.createElement(
            TagName,
            (0, _extends3.default)({}, tagAttrs, { onMouseUp: this.onMouseUp, ref: this.buttonRefHandler, role: 'button' }),
            clonedChildren
        );
    };
...
exports.default = _nextConfigProvider2.default.config(Button);
