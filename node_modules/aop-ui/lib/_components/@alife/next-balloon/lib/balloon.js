...
var Balloon = (_temp = _class = function (_React$Component) {
  ...
  Balloon.prototype.render = function render() {
    var _props = this.props,
        ...
        others = (0, _objectWithoutProperties3.default)(_props, ['type', 'prefix', 'className', 'alignEdge', 'trigger', 'triggerType', 'children', 'closable', 'shouldUpdatePosition', 'delay', 'needAdjust', 'safeId', 'autoFocus', 'safeNode', 'onClick', 'onHover', 'animation', 'offset', 'style', 'container', 'cache', 'popupStyle', 'popupClassName', 'popupProps']);
    ...
    var content = _react2.default.createElement(
      _inner2.default,
      (0, _extends3.default)({}, _nextUtil.obj.pickOthers(Object.keys(Balloon.propTypes), others), {
        prefix: _prefix,
        closable: closable,
...
exports.default = _nextConfigProvider2.default.config(Balloon);
