...
var BalloonInner = (_temp = _class = function (_React$Component) {
    ...
    BalloonInner.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'closable', 'className', 'style', 'isTooltip', 'align', 'type', 'onClose', 'alignEdge', 'children']);
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({ className: classes, style: style }, _nextUtil.obj.pickOthers(Object.keys(BalloonInner.propTypes), others)),
            closable ? _react2.default.createElement(
                'a',
                { href: 'javascript:void(0);', className: _prefix + '-close',
                    onClick: onClose },
