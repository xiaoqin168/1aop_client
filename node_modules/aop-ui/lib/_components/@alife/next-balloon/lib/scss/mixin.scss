...
@mixin balloon-bounding($border-style) {
    position: absolute;
    border: $popup-global-border-width $border-style transparent;
...
@mixin balloon-arrow(
    ...
    &:after {
        ...
        border: $widthBorder $popup-global-border-style $colorBorder;
        background-color: $colorBg;
        z-index: -1;
    }
    &.#{$css-prefix}balloon-top:after {
        top: $arrorExpose;
        left: calc(#{$arrowCenter});
        border-right: none;
        border-bottom: none;
        box-shadow: $shadow-top;
    }
    &.#{$css-prefix}balloon-right:after {
        top: calc(#{$arrowCenter});
        right: $arrorExpose;
        border-left: none;
        border-bottom: none;
...
@mixin tooltip-arrow(
    ...
    &:after {
        ...
        content: ' ';
        transform: rotate(45deg);
        border: $popup-global-border-width $balloon-tooltip-border-style $colorBorder;
        background-color: $colorBg;
        z-index: -1;
    }
    &-top:after {
