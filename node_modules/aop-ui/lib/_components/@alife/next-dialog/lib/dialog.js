...
var limitTabRange = _nextUtil.focus.limitTabRange;
...
var Dialog = (_temp = _class = function (_Component) {
    ...
    Dialog.prototype.componentDidMount = function componentDidMount() {
        _nextUtil.events.on(document, 'keydown', this.onKeyDown);
    ...
    Dialog.prototype.componentWillUnmount = function componentWillUnmount() {
        _nextUtil.events.off(document, 'keydown', this.onKeyDown);
    };
    ...
    Dialog.prototype.mapcloseableToConfig = function mapcloseableToConfig(closeable) {
        return ['esc', 'outSide', 'close', 'mask'].reduce(function (ret, option) {
    ...
    Dialog.prototype.render = function render() {
        ...
        var newOverlayProps = (0, _extends3.default)({}, overlayProps, {
            prefix: prefix,
            visible: visible,
            animation: animation,
            hasMask: hasMask,
...
}, _class.show = function (config) {
    return (0, _show.show)(config);
}, _class.alert = function (config) {
    return (0, _show.alert)(config);
}, _class.confirm = function (config) {
    return (0, _show.confirm)(config);
}, _temp);
Dialog.displayName = 'Dialog';
exports.default = _nextConfigProvider2.default.config(Dialog);
