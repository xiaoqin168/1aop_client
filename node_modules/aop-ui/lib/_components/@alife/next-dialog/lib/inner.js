...
var Inner = (_temp = _class = function (_Component) {
    ...
    Inner.prototype.renderHeader = function renderHeader() {
        ...
        if (title) {
            this.titleId = (0, _nextUtil.guid)('dialog-title-');
    ...
    Inner.prototype.renderFooter = function renderFooter() {
        ...
        var footerContent = footer === true || !footer ? footerActions.map(function (action) {
            ...
            var newBtnProps = (0, _extends3.default)({}, btnProps, {
                ...
                children: locale[action]
            });
            if (action === 'ok') {
                newBtnProps.type = 'primary';
            }

            return _react2.default.createElement(_nextButton2.default, (0, _extends3.default)({ key: action }, newBtnProps));
        }) : footer;
        ...
        if (closeable) {
            return _react2.default.createElement(
                ...
                { href: 'javascript:;', className: prefix + 'dialog-close',
                    onClick: onClose },
                _react2.default.createElement(_nextIcon2.default, { className: prefix + 'dialog-close-icon', type: 'close' })
            );
        }
    ...
    Inner.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({}, ariaProps, { className: newClassName }, others),
            header,
            body,
            footer,
            closeLink
