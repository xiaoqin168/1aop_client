@charset "UTF-8";
@import "../../next-core/lib/index-noreset.scss";
...
#{$search-prefix} {
    ...
    &-normal {
        ...
        &.#{$css-prefix}dark {
            ...
            .#{$css-prefix}input {
                background: transparentize($search-normal-dark-bg-color, $search-normal-dark-bg-color-transparent);
            }
            .#{$css-prefix}select {
                background: transparentize($search-normal-dark-bg-color, $search-normal-dark-bg-color-transparent);
            }
    ...
    &-simple {
        ...
        &.#{$css-prefix}dark {
            @include search-simple-color( $search-simple-dark-color, $search-simple-dark-color, $search-simple-dark-icon-text-color, $search-simple-dark-icon-hover-text-color, $search-simple-dark-split-color );
            ...
            .#{$css-prefix}input {
                background: transparentize($search-simple-dark-bg-color, $search-simple-dark-bg-color-transparent);
            }
            .#{$css-prefix}select {
                background: transparentize($search-simple-dark-bg-color, $search-simple-dark-bg-color-transparent);
            }
