...
var Circle = (_temp = _class = function (_Component) {
    ...
    Circle.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'size', 'state', 'percent', 'className', 'textRender', 'progressive']);
        ...
        var pathCls = (0, _classnames2.default)((_classNames2 = {}, _classNames2[prefix + 'progress-circle-overlay'] = true, _classNames2[prefix + 'progress-circle-overlay-' + state] = !progressive && state, _classNames2[prefix + 'progress-circle-overlay-started'] = progressive && percent <= 30, _classNames2[prefix + 'progress-circle-overlay-middle'] = progressive && percent > 30 && percent < 80, _classNames2[prefix + 'progress-circle-overlay-finishing'] = progressive && percent >= 80, _classNames2));

        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({}, others, { className: wrapCls }),
            _react2.default.createElement(
                'svg',
                { className: prefix + 'progress-circle-container', viewBox: viewBox },
                _react2.default.createElement('path', { className: prefix + 'progress-circle-underlay', d: underlayPath, fillOpacity: '0', ref: this._underlayRefHandler }),
