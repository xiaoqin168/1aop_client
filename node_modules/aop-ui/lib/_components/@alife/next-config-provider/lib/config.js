...
var _getContextProps = require('./get-context-props.js');

var _getContextProps2 = _interopRequireDefault(_getContextProps);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var shallowEqual = _nextUtil.obj.shallowEqual;
...
function config(Component) {
    ...
    var ConfigedComponent = (_temp = _class = function (_React$Component) {
        ...
        ConfigedComponent.prototype.render = function render() {
            var _props = this.props,
                ...
                pure = _props.pure,
                others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'locale', 'pure']);
            ...
            var contextProps = (0, _getContextProps2.default)({ prefix: prefix, locale: locale, pure: pure }, { nextPrefix: nextPrefix, nextLocale: (0, _extends3.default)({}, currentGlobalLocale, nextLocale), nextPure: nextPure }, displayName);

            return _react2.default.createElement(Component, (0, _extends3.default)({}, others, { prefix: contextProps.prefix, locale: contextProps.locale, pure: contextProps.pure, ref: this._getInstance }));
        };
    ...
    }), _class.displayName = 'Config(' + getDisplayName(Component) + ')', _temp);
