...
var Paragraph = (_temp = _class = function (_React$Component) {
    ...
    Paragraph.prototype.render = function render() {
        var _props = this.props,
            ...
            type = _props.type,
            size = _props.size,
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'className', 'type', 'size']);
    ...
    /**
     * 什么方式展示段落。 默认：long 展示所有文本，short 展示三行以内（非强制）
     */
    type: _propTypes2.default.string,
    /**
     * 组件大小。 默认：medium 中号，small 小号
     */
...
exports.default = _nextConfigProvider2.default.config(Paragraph);
