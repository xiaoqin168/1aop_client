...
var TextArea = (_temp = _class = function (_Base) {
    ...
    TextArea.prototype.ieHack = function ieHack(value) {
        ...
        /* istanbul ignore if */
        if (_nextUtil.env.ieVersion && this.props.maxLength && this.props.multiple) {
    ...
    TextArea.prototype.render = function render() {
        ...
        var wrapStyle = autoHeight ? (0, _extends3.default)({}, style, {
            position: 'relative'
        }) : style;

        return _react2.default.createElement(
            'span',
            (0, _extends3.default)({ className: cls, style: wrapStyle }, _nextUtil.obj.pickOthers(TextArea.propTypes, this.props)),
            _react2.default.createElement('textarea', (0, _extends3.default)({}, props, {
                'data-real': true,
                rows: rows,
                style: textareStyle,
                ref: this.saveRef.bind(this) })),
            autoHeight ? _react2.default.createElement('textarea', { 'data-fake': true, ref: this.saveHelpRef.bind(this), style: (0, _extends3.default)({}, props.style, hiddenStyle),
                rows: '1' }) : null,
            this.renderControl()
        );
    };
...
exports.default = _nextConfigProvider2.default.config(TextArea);
