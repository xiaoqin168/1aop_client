...
var Input = (_temp = _class = function (_Base) {
    ...
    Input.prototype.renderControl = function renderControl() {
        ...
        var stateWrap = null;
        if (state === 'success') {
            stateWrap = _react2.default.createElement(_nextIcon2.default, { type: 'success-filling' });
        } else if (state === 'loading') {
            stateWrap = _react2.default.createElement(_nextIcon2.default, { type: 'loading' });
        }
        ...
        if (hint || showClear) {
            var hintIcon = null;
            if (hint) {
                hintIcon = _react2.default.createElement(_nextIcon2.default, { type: hint, className: prefix + 'input-hint' });
            } else {
                hintIcon = _react2.default.createElement(_nextIcon2.default, { type: 'delete-filling', className: prefix + 'input-hint', onClick: this.onClear.bind(this), onMouseDown: preventDefault });
            }

            clearWrap = _react2.default.createElement(
                'span',
                { className: prefix + 'input-hint-wrap' },
                hasClear && hint ? _react2.default.createElement(_nextIcon2.default, { type: 'delete-filling', className: prefix + 'input-clear', onClick: this.onClear.bind(this),
    ...
    Input.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Input.propTypes, this.props);
        ...
        var inputWrap = _react2.default.createElement(
            'span',
            (0, _extends3.default)({}, others, { className: cls, style: hasAddon ? undefined : style }),
    ...
    onPressEnter: _nextUtil.func.noop,
    inputRender: function inputRender(el) {
        return el;
    }
}), _temp);
exports.default = _nextConfigProvider2.default.config(Input);
