...
var RadioGroup = (_temp = _class = function (_Component) {
    ...
    RadioGroup.prototype.render = function render() {
        ...
        var cls = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'radio-group'] = true, _classnames[prefix + 'radio-button'] = shape === 'button', _classnames[prefix + 'radio-button-' + size] = shape === 'button', _classnames[className] = !!className, _classnames.disabled = disabled, _classnames));

        return _react2.default.createElement(
            'div',
            (0, _extends3.default)({}, others, { id: id, className: cls, style: style }),
            children
        );
    };
...
exports.default = _nextConfigProvider2.default.config(RadioGroup);
