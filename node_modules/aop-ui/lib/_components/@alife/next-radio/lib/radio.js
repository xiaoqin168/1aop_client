...
var Radio = (_temp = _class = function (_UIState) {
    ...
    Radio.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Radio.propTypes, otherProps);
        var othersData = _nextUtil.obj.pickAttrsWith(others, 'data-');

        var input = _react2.default.createElement('input', (0, _extends3.default)({}, _nextUtil.obj.pickOthers(othersData, others), {
            id: id,
            disabled: disabled,
            checked: checked,
            type: 'radio',
...
exports.default = _nextConfigProvider2.default.config(Radio);
