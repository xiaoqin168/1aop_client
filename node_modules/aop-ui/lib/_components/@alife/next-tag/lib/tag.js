...
var Tag = (_temp = _class = function (_Component) {
    ...
    Tag.prototype.handleClose = function handleClose(from) {
        ...
        var hasAnimation = _nextUtil.support.animation && animation;
    ...
    Tag.prototype.renderTailNode = function renderTailNode() {
        ...
        return _react2.default.createElement(
            'span',
            { className: prefix + 'tag-close-btn', onClick: this.handleTailClick },
    ...
    Tag.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(Tag.propTypes, this.props);
        ...
        var tagNode = !visible ? null : _react2.default.createElement(
            'div',
            (0, _extends3.default)({ ref: function ref(n) {
                    return _this3.tagNode = n;
                }, className: bodyClazz, onClick: this.handleBodyClick }, others),
...
Tag.displayName = 'Tag';
exports.default = _nextConfigProvider2.default.config(Tag);
