...
var _class, _temp; /**
                    ...
                    * @create 2017/10/23
                    *
                    * checkable tag 是一个纯受控组件，内部不管理 checked 状态。
                    */
...
var Selectable = (_temp = _class = function (_Component) {
    ...
    Selectable.prototype.render = function render() {
        ...
        var others = _nextUtil.obj.pickOthers(attrFilterTarget, this.props);
        ...
        return _react2.default.createElement(_tag2.default, (0, _extends3.default)({}, others, { _shape: 'checkable', className: clazz, onClick: this.handleClick }));
    };
...
exports.default = _nextConfigProvider2.default.config(Selectable);
