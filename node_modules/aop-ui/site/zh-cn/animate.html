...
<body><script>
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=&aplus&yunid=&&trid=0bbbeff215249006517304133e1a7d&asid=AQAAAAAsI+Rahl0UaAAAAAA2H7q/j4f9lg==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>
...
<div class="demo-wrapper pc">
  <div class="demo-index">
    <ul class="demo-index-list">
      ...
      <li class="demo-index-item demo-index-item-sub">
        <a href="#animate-0">基本</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#animate-2">多个子元素动画</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#animate-1">展开收起动画</a>
      </li>
  ...
  <div class="demo-guide markdown" id="demo-guide"><h2 id="开发指南">开发指南<a href="#开发指南" class="anchor">#</a></h2><h3 id="何时使用">何时使用<a href="#何时使用" class="anchor">#</a></h3><p>需要自定义动效</p>
...
<tr>
<td>onAppear</td>
<td>执行第一次挂载动画，添加 xxx-appear-active 类名后触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>afterAppear</td>
<td>执行完第一次挂载动画后触发的函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>beforeEnter</td>
<td>执行进场动画前触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>onEnter</td>
<td>执行进场动画，添加 xxx-enter-active 类名后触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>afterEnter</td>
<td>执行完进场动画后触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>beforeLeave</td>
<td>执行离场动画前触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>onLeave</td>
<td>执行离场动画，添加 xxx-leave-active 类名后触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
<tr>
<td>afterLeave</td>
<td>执行完离场动画后触发的回调函数<br><br><strong>签名</strong>:<br>Function(node: HTMLElement) =&gt; void<br><strong>参数</strong>:<br><em>node</em>: {HTMLElement} 执行动画的 dom 元素</td>
<td>Function</td>
<td>() =&gt; {}</td>
</tr>
</tbody>
  ...
  <div class="demo-list" id="demo-list">
    ...
    <div class="demo-list-item" id="animate-0">
      <div class="demo-list-item-header">
        <a href="#animate-0" class="title">基本</a>
      </div>
...
<p>展示单个子元素的进场离场动画。</p>
    ...
    <div class="demo-list-item" id="animate-2">
      <div class="demo-list-item-header">
        <a href="#animate-2" class="title">多个子元素动画</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>展示多个子元素的进场离场动画。</p>
    ...
    <div class="demo-list-item" id="animate-1">
      <div class="demo-list-item-header">
        <a href="#animate-1" class="title">展开收起动画</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
