...
<body><script>
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=&aplus&yunid=&&trid=0bbbeff215249006517291995e1a7c&asid=AQAAAAAsI+RabPwBQwAAAADeEaydQRAFXQ==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>
...
<div class="demo-wrapper pc">
  <div class="demo-index">
    <ul class="demo-index-list">
      ...
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-3">自定义数据获取</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-4">关联控制</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-6">自定义错误</a>
      </li>
      ...
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-5">redux中使用</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-2">组合使用</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-9">自定义受控字段</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-1">自定义组件使用</a>
      </li>
      
      <li class="demo-index-item demo-index-item-sub">
        <a href="#field-7">获取对象或数组</a>
      </li>
  ...
  <div class="demo-guide markdown" id="demo-guide"><h2 id="开发指南">开发指南<a href="#开发指南" class="anchor">#</a></h2><h3 id="何时使用">何时使用<a href="#何时使用" class="anchor">#</a></h3><p>涉及到表单数据操作、校验的地方都可以用Field来管理数据。和组件关联后可以自动对表单数据进行回写、读取、校验。</p>
...
<li>initValue 类似组件的 defauValue， 只有在组件第一次render的时候才生效(ajax异步调用设置initValue可能已经错过了第一次render)</li>
</ul>
...
<h2 id="api">API<a href="#api" class="anchor">#</a></h2><h3 id="初始化">初始化<a href="#初始化" class="anchor">#</a></h3><pre>let myfield = new Field(this [,options]);</pre><table>
<thead>
<tr>
<th>参数</th>
<th>说明</th>
...
<tr>
<td>validator</td>
<td>自定义校验,(校验成功的时候不要忘记执行 <code>callback()</code>,否则会校验不返回)</td>
...
<h2 id="自定义组件接入field标准-详细见">自定义组件接入Field标准 <a href="http://gitlab.alibaba-inc.com/next/1.x/issues/2" target="_blank">详细见</a><a href="#自定义组件接入field标准-详细见" class="anchor">#</a></h2><ul>
...
<li><p><code>value={undefined}</code>的时候清空数据, field的reset函数会给所有组件下发undefined数据 <code>建议</code></p>
</li>
</ul>
  ...
  <div class="demo-list" id="demo-list">
    ...
    <div class="demo-list-item" id="field-0">
      <div class="demo-list-item-header">
        <a href="#field-0" class="title">基本</a>
      </div>
...
<p><code>getValue</code> <code>setValue</code> <code>reset</code> 的使用</p>
    ...
    <div class="demo-list-item" id="field-3">
      <div class="demo-list-item-header">
        <a href="#field-3" class="title">自定义数据获取</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>通过 <code>getValueFromEvent</code> 自定义从组件的 <code>Event</code> 获取 <code>value</code> 的方式</p>
    ...
    <div class="demo-list-item" id="field-4">
      <div class="demo-list-item-header">
        <a href="#field-4" class="title">关联控制</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>组件之间的关联控制. <code>onChange</code> 统一管理。</p>
    ...
    <div class="demo-list-item" id="field-6">
      <div class="demo-list-item-header">
        <a href="#field-6" class="title">自定义错误</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>自己控制组件的errors</p>
    ...
    <div class="demo-list-item" id="field-8">
      <div class="demo-list-item-header">
        <a href="#field-8" class="title">校验</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p><code>注意</code>：Form和Field做了深度结合，在Form中使用Field，错误信息不需<code>getError</code>获取会自动展现。</p>
    ...
    <div class="demo-list-item" id="field-5">
      <div class="demo-list-item-header">
        <a href="#field-5" class="title">redux中使用</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>在redux中使用, 在componentWillReceiveProps更新</p>
    ...
    <div class="demo-list-item" id="field-2">
      <div class="demo-list-item-header">
        <a href="#field-2" class="title">组合使用</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>多组件混合使用</p>
    ...
    <div class="demo-list-item" id="field-9">
      <div class="demo-list-item-header">
        <a href="#field-9" class="title">自定义受控字段</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>valueName的默认值为value，如果为其他需要用valueName指定</p>
    ...
    <div class="demo-list-item" id="field-1">
      <div class="demo-list-item-header">
        <a href="#field-1" class="title">自定义组件使用</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
...
<p>自己的组件如何接入Field。</p>
<p><code>最低标准</code>: 组件有<code>onChange</code>事件可以读取组件数据。<code>达到效果</code>：Field可以getValue，但是setValue无效</p>
<p><code>完全支持</code>: 组件支持<a href="https://facebook.github.io/react/docs/forms.html#controlled-components">受控</a>， 也就是支持两个api：<code>value</code> <code>onChange</code>. value: 设置组件的数据; onChange: 在组件修改的时候在第一个数暴露数据</p>
    ...
    <div class="demo-list-item" id="field-7">
      <div class="demo-list-item-header">
        <a href="#field-7" class="title">获取对象或数组</a>
      </div>
      <div class="demo-list-item-body">
        <div class="demo-list-item-viewbox">
