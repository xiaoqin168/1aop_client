...
.next-badge {
  ...
  .next-badge .next-badge-custom {
    ...
    .next-badge .next-badge-custom > * {
      line-height: 1; }
    .next-badge .next-badge-custom > i:before, .next-badge .next-badge-custom > .next-icon:before {
      font-size: inherit;
      width: auto;
      vertical-align: top; }
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_613710_z59z919zgtfyldi.eot");
  src: url("//at.alicdn.com/t/font_613710_z59z919zgtfyldi.eot?#iefix") format("embedded-opentype"), url("//at.alicdn.com/t/font_613710_z59z919zgtfyldi.woff") format("woff"), url("//at.alicdn.com/t/font_613710_z59z919zgtfyldi.ttf") format("truetype"), url("//at.alicdn.com/t/font_613710_z59z919zgtfyldi.svg#NextIcon") format("svg"); }
...
.next-radio-wrapper:not(.disabled):hover .next-radio-inner, .next-radio-wrapper:not(.disabled).hovered .next-radio-inner, .next-radio-wrapper:not(.disabled).focused .next-radio-inner {
  border-color: #5584FF;
  background-color: #FFFFFF; }

.next-radio-wrapper.checked:not(.disabled):hover .next-radio-inner, .next-radio-wrapper.checked:not(.disabled).hovered .next-radio-inner, .next-radio-wrapper.checked.focused .next-radio-inner {
  border-color: #5584FF;
  background: #FFFFFF; }
  .next-radio-wrapper.checked:not(.disabled):hover .next-radio-inner:after, .next-radio-wrapper.checked:not(.disabled).hovered .next-radio-inner:after, .next-radio-wrapper.checked.focused .next-radio-inner:after {
    background: #5584FF; }
...
.next-tag-checkable.next-tag-level-secondary {
  ...
  border-color: transparent;
  background-color: transparent; }
  .next-tag-checkable.next-tag-level-secondary:hover, .hover.next-tag-checkable.next-tag-level-secondary {
    color: #5584FF; }
...
.next-tag-default.next-tag-level-primary, .next-tag-closable.next-tag-level-primary {
  ...
  border-color: #F7F8FA;
  background-color: #F7F8FA; }
  .next-tag-default.next-tag-level-primary:hover, .next-tag-closable.next-tag-level-primary:hover, .hover.next-tag-default.next-tag-level-primary, .hover.next-tag-closable.next-tag-level-primary {
    color: #333333;
    border-color: #FFFFFF;
    background-color: #FFFFFF; }
    .next-tag-default.next-tag-level-primary:hover > .next-tag-close-btn, .next-tag-closable.next-tag-level-primary:hover > .next-tag-close-btn, .hover.next-tag-default.next-tag-level-primary > .next-tag-close-btn, .hover.next-tag-closable.next-tag-level-primary > .next-tag-close-btn {
      color: #333333; }
...
.next-tag-checkable.next-tag-level-primary {
  ...
  .next-tag-checkable.next-tag-level-primary:hover, .hover.next-tag-checkable.next-tag-level-primary {
    color: #333333;
    border-color: #DEEDED;
    background-color: #DEEDED; }
    .next-tag-checkable.next-tag-level-primary:hover > .next-tag-close-btn, .hover.next-tag-checkable.next-tag-level-primary > .next-tag-close-btn {
      color: #333333; }
...
.next-tag-checkable.next-tag-level-primary.checked {
  ...
  border-color: #5584FF;
  background-color: #5584FF; }
  .next-tag-checkable.next-tag-level-primary.checked:hover, .hover.next-tag-checkable.next-tag-level-primary.checked {
    color: #FFFFFF;
    border-color: #3E71F7;
    background-color: #3E71F7; }
    .next-tag-checkable.next-tag-level-primary.checked:hover > .next-tag-close-btn, .hover.next-tag-checkable.next-tag-level-primary.checked > .next-tag-close-btn {
      color: #FFFFFF; }
...
.next-tag-default.next-tag-level-normal {
  ...
  border-color: #CCCCCC;
  background-color: transparent; }
  .next-tag-default.next-tag-level-normal:hover, .hover.next-tag-default.next-tag-level-normal {
    color: #5584FF;
    border-color: #5584FF;
    background-color: transparent; }
    .next-tag-default.next-tag-level-normal:hover > .next-tag-close-btn, .hover.next-tag-default.next-tag-level-normal > .next-tag-close-btn {
      color: #333333; }
...
.next-tag-closable.next-tag-level-normal {
  ...
  border-color: #CCCCCC;
  background-color: transparent; }
  .next-tag-closable.next-tag-level-normal:hover, .hover.next-tag-closable.next-tag-level-normal {
    color: #333333;
    border-color: #888888;
    background-color: transparent; }
    .next-tag-closable.next-tag-level-normal:hover > .next-tag-close-btn, .hover.next-tag-closable.next-tag-level-normal > .next-tag-close-btn {
      color: #333333; }
...
.next-tag-checkable.next-tag-level-normal.checked, .next-tag-checkable.next-tag-level-secondary.checked {
  ...
  border-color: #5584FF;
  background-color: transparent; }
  .next-tag-checkable.next-tag-level-normal.checked:hover, .next-tag-checkable.next-tag-level-secondary.checked:hover, .hover.next-tag-checkable.next-tag-level-normal.checked, .hover.next-tag-checkable.next-tag-level-secondary.checked {
    color: #3E71F7;
    border-color: #3E71F7;
    background-color: transparent; }
...
.hover.next-tag-checkable.next-tag-level-secondary.checked:before, .next-tag-checkable.next-tag-level-secondary.checked:hover:before {
  background-color: #3E71F7; }

.hover.next-tag-checkable.next-tag-level-secondary.checked:after, .next-tag-checkable.next-tag-level-secondary.checked:hover:after {
  color: #FFFFFF; }
...
.next-tag-checkable.next-tag-level-normal {
  ...
  border-color: #CCCCCC;
  background-color: transparent; }
  .next-tag-checkable.next-tag-level-normal:hover, .hover.next-tag-checkable.next-tag-level-normal {
    color: #333333;
    border-color: #CCCCCC;
    background-color: transparent; }
...
.hover.next-tag-checkable.next-tag-level-normal.checked:before, .next-tag-checkable.next-tag-level-normal.checked:hover:before {
  background-color: #3E71F7; }

.hover.next-tag-checkable.next-tag-level-normal.checked:after, .next-tag-checkable.next-tag-level-normal.checked:hover:after {
  color: #FFFFFF; }
...
.hover.next-tag-closable.next-tag-level-normal:before, .next-tag-closable.next-tag-level-normal:hover:before {
  background-color: #888888; }

.hover.next-tag-closable.next-tag-level-normal:after, .next-tag-closable.next-tag-level-normal:hover:after {
  color: #FFFFFF; }
...
.next-select {
  ...
  .next-select-multiple, .next-select-tag {
    ...
    .next-select-multiple.next-small .next-tag, .next-select-tag.next-small .next-tag {
      ...
      padding-bottom: 0px;
      height: 14px; }
      .next-select-multiple.next-small .next-tag .next-tag-body, .next-select-tag.next-small .next-tag .next-tag-body {
        line-height: 14px; }
    ...
    .next-select-multiple.next-medium .next-tag, .next-select-tag.next-medium .next-tag {
      ...
      padding-bottom: 1px;
      height: 20px; }
      .next-select-multiple.next-medium .next-tag .next-tag-body, .next-select-tag.next-medium .next-tag .next-tag-body {
        line-height: 18px; }
    ...
    .next-select-multiple.next-large .next-tag, .next-select-tag.next-large .next-tag {
      ...
      padding-bottom: 3px;
      height: 24px; }
      .next-select-multiple.next-large .next-tag .next-tag-body, .next-select-tag.next-large .next-tag .next-tag-body {
        line-height: 18px; }
...
.next-date-picker, .next-range-picker {
  -webkit-box-sizing: border-box;
          box-sizing: border-box; }
  .next-date-picker *,
  ...
  .next-range-picker *:after {
    -webkit-box-sizing: border-box;
            box-sizing: border-box; }
  .next-date-picker-body, .next-range-picker-body {
    border: 1px solid #E2E2E2;
    border-radius: 0;
    -webkit-box-shadow: none;
            box-shadow: none;
    background: #FFFFFF; }
  .next-date-picker-panel-header, .next-range-picker-panel-header {
    padding: 6px;
    text-align: center; }
  .next-date-picker-panel-time, .next-range-picker-panel-time {
    border-top: 1px solid #E2E2E2; }
  .next-date-picker-panel-footer, .next-range-picker-panel-footer {
    text-align: right;
    padding: 8px 20px;
    border-top: 1px solid #E2E2E2; }
  .next-date-picker-panel-footer > .next-btn:not(:last-child), .next-range-picker-panel-footer > .next-btn:not(:last-child) {
    margin-right: 16px; }
  .next-date-picker .next-calendar-panel-header, .next-range-picker .next-calendar-panel-header {
    margin-left: -1px;
    margin-right: -1px; }
  .next-date-picker .next-input input, .next-range-picker .next-input input {
    vertical-align: baseline; }
...
.next-nav {
  ...
  .next-nav.next-primary {
    ...
    .next-nav.next-primary .next-menu-item {
      background-color: #333333;
      color: #FFFFFF; }
      .next-nav.next-primary .next-menu-item.next-focused, .next-nav.next-primary .next-menu-item:hover {
  ...
  .next-nav.next-secondary {
    ...
    .next-nav.next-secondary .next-menu-item {
      background-color: #5584FF;
      color: #FFFFFF; }
      .next-nav.next-secondary .next-menu-item.next-focused, .next-nav.next-secondary .next-menu-item:hover {
        background-color: #3E71F7;
        color: #FFFFFF; }
  ...
  .next-nav.next-normal {
    ...
    .next-nav.next-normal .next-menu-item {
      background-color: #FFFFFF;
      color: #333333; }
      .next-nav.next-normal .next-menu-item.next-focused, .next-nav.next-normal .next-menu-item:hover {
        background-color: #FFFFFF;
        color: #5584FF; }
  ...
  .next-nav.next-line {
    ...
    .next-nav.next-line .next-menu-item {
      background-color: transparent;
      color: #333333; }
      .next-nav.next-line .next-menu-item.next-focused, .next-nav.next-line .next-menu-item:hover {
        background-color: transparent;
        color: #5584FF; }
...
.next-switch {
  ...
  .next-switch:after {
    content: " ";
    -webkit-transition: left 0.4s cubic-bezier(0.78, 0.14, 0.15, 0.86);
    transition: left 0.4s cubic-bezier(0.78, 0.14, 0.15, 0.86);
    -webkit-transform-origin: left center;
        -ms-transform-origin: left center;
            transform-origin: left center;
    z-index: 1; }
...
.next-tabs {
  ...
  .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab {
    ...
    .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab.active {
      border-color: #FFFFFF #E2E2E2 #E2E2E2 #E2E2E2; }
  ...
  .next-tabs-wrapped.next-tabs-left > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab {
      ...
      .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab.active {
        border-color: #E2E2E2 #FFFFFF #E2E2E2 #E2E2E2; }
  ...
  .next-tabs-wrapped.next-tabs-right > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab {
      ...
      .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab.active {
        border-color: #E2E2E2 #E2E2E2 #E2E2E2 #FFFFFF; }
